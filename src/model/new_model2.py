...
class HNCT(nn.Module):
    def __init__(self, in_nc=3, nf=50, num_modules=4, out_nc=3, upscale=4):
        ...
        self.B1 = B.P_HCTB(in_channels=nf)
        self.B2 = B.P_HCTB(in_channels=nf)
        self.B3 = B.P_HCTB(in_channels=nf)
        self.B4 = B.P_HCTB(in_channels=nf)
